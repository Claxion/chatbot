...
"""
print("===2===")
print( "requests" in ssafy['language']['python']['python standard library']) # 키가 없으면 예외를 뱉음

print(ssafy['language']['python'].get('library')) # 키가 없으면 None을 리턴
...
for name in ssafy['classes']['gm'].values() : 
    print(name)
# for val in ssafy['classes']['seoul'].values() : 
#     if type(val) != type("a") : 
#         continue
#     else :
#         print(val)
